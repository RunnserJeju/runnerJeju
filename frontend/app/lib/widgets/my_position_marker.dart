...
/// 마커 한 변(dp).
const double myPositionMarkerSize = 21;
...
Future<kakao.KImage> _build() async {
  ...
  try {
    return await rasterizeMarker(
      width: myPositionMarkerSize,
      height: myPositionMarkerSize,
      draw: (canvas) => canvas
        ..scale(
          myPositionMarkerSize / info.size.width,
          myPositionMarkerSize / info.size.height,
        )
