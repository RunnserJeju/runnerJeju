...
/// 알약 배지 이미지. 폭은 글자 길이에 맞춘다. 라벨은 세 종류뿐이라 색·라벨별로
/// 한 번만 그려 두고 재사용한다.
Future<kakao.KImage> buildCourseEndpointChip(Color color, String label) =>
...
Future<kakao.KImage> _build(Color color, String label) {
  ...
  final w = (painter.width + _chipHPadding * 2 + _chipBorder * 2)
      .ceilToDouble();
  const h = _chipHeight;
